...
service.get('/service/:location', (req, res, next) => {
	const urlGeocode = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + req.params.location + '&key=AIzaSyD76bEc6bijgfEqFU8KdxQHZXdcEdUZTIQ';
	request.get(urlGeocode, (err, response) => {
		...
		const urlGeometryKey = '&key=AIzaSyBYi6jcaly88hlM9Ai5QzznsF9FtVrWHoc';
